        ...
        <>
            <div className="page-content">
                <div className="overlay-black-dark profile-edit p-t50 p-b20" style={{ backgroundImage: `url(${bnr.default.src})` }}>
                                ...
                                <div className="candidate-detail">
                                    ...
                                    <div className="text-white browse-job text-left">
                                        <h4 className="m-b0">John Doe
                                            <Link href='' onClick={() => setShowBasicDetails(true)} className="m-l15 font-16 text-white"><i className="fa fa-pencil"></i></Link>
                                        </h4>
                    ...
                    <BasicDetailsModal show={showBasicDetails} onShow={() => setShowBasicDetails(true)} onHide={() => setShowBasicDetails(false)} />
                </div>
                        ...
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col-xl-9 col-lg-8 col-md-8 col-sm-12">
                                    <ResumeHeadline show={showResume} onShow={() => setShowResume(true)} onHide={() => setShowResume(false)} />
                                    <KeySkills show={showKeySkills} onShow={() => setShowKeySkills(true)} onHide={() => setShowKeySkills(false)} />
                                    <Employment show={showEmployment} onShow={() => setShowEmployment(true)} onHide={() => setShowEmployment(false)} />
                                    <Education show={showEducation} onShow={() => setShowEducation(true)} onHide={() => setShowEducation(false)} />
                                    <ItSkills show={showItSkills} onShow={() => setShowItSkills(true)} onHide={() => setShowItSkills(false)} />
                                    <Projects show={showProjects} onShow={() => setShowProjects(true)} onHide={() => setShowProjects(false)} />
                                    <ProfileSummary show={showProfileSummary} onShow={() => setShowProfileSummary(true)} onHide={() => setShowProfileSummary(false)} />
                                    <Accomplishments
                                        showOnlineProfile={showOnlineProfile}
                                        showWorkSample={showWorkSample}
                                        showWhitePaper={showWhitePaper}
                                        showPresentation={showPresentation}
                                        showPatent={showPatent}
                                        showCertification={showCertification}
                                        onShowOnlineProfile={() => setShowOnlineProfile(true)}
                                        onShowWorkSample={() => setShowWorkSample(true)}
                                        onShowWhitePaper={() => setShowWhitePaper(true)}
                                        onShowPresentation={() => setShowPresentation(true)}
                                        onShowPatent={() => setShowPatent(true)}
                                        onShowCertification={() => setShowCertification(true)}
                                        onHide={() => {
                                            setShowOnlineProfile(false);
                                    ...
                                    />
                                    <DesiredCareerProfile show={showCareerProfile} onShow={() => setShowCareerProfile(true)} onHide={() => setShowCareerProfile(false)} />
                                    <PersonalDetails show={showPersonalDetails} onShow={() => setShowPersonalDetails(true)} onHide={() => setShowPersonalDetails(false)} />
                                    <AttachResume />
                                </div>
                            </div>
                        </div>
