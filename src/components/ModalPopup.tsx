...
import { JobData } from "@/app/manage-job/types";
...
const ModalPopup = ({
  ...
  const handleToggleSelect = (
    ...
    if (isMultiSelect) {
      ...
      valueToDispatch =
        valueToDispatch !== null ? valueToDispatch.toString() : "";
    }
                      ...
                      {["Fixed Only", "Fixed + Incentive"].map(
                        (text, index) => (
                          <span
                            ...
                            onMouseEnter={() =>
                              handleMouseEnter(index, setIsCompensationHovered)
                            }
                            onMouseLeave={() =>
                              handleMouseLeave(index, setIsCompensationHovered)
                            }
                            onClick={() =>
                              handleToggleSelect(
                                index + 1,
                    ...
                    >
                      {[
                        ...
                        <span
                          ...
                          onMouseEnter={() =>
                            handleMouseEnter(index, setIsAdditionalPerkHovered)
                          }
                          onMouseLeave={() =>
                            handleMouseLeave(index, setIsAdditionalPerkHovered)
                          }
                          onClick={() =>
                            handleToggleSelect(
                              index + 1,
                    ...
                    >
                      {["No", "YES"].map((text, index) => (
                        <span
                          ...
                          onMouseEnter={() =>
                            handleMouseEnter(index, setIsJoiningFeeHovered)
                          }
                          onMouseLeave={() =>
                            handleMouseLeave(index, setIsJoiningFeeHovered)
                          }
                          onClick={() =>
                            handleToggleSelect(
                              index + 1,
